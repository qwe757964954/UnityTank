...
namespace Complete
{
    public class PropResManager : MonoBehaviour
    {
        public Sprite[] spriteObjArray;
        // Use this for initialization
        static PropResManager instance = null;

        string[] mWordList;

        Dictionary<string, Sprite> spriteObjDict = new Dictionary<string, Sprite>();

        public static PropResManager Get
        {
            get
            {
                if (instance == null)
                {
                    instance = Object.FindObjectOfType<PropResManager>();
                }
                return instance;
            }
